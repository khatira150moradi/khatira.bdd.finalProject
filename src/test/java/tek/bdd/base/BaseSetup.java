...
public abstract class BaseSetup {
    ...
    public BaseSetup() {
        ...
        try {
            ...
            throw new RuntimeException("Something wrong with config file");
        }
    }
    ...
    public void openBrowser(){
        ...
        if (browserType.equalsIgnoreCase("chrome"))
            ...
            throw new RuntimeException("Wrong browser type, choose another browser such as chrome, firefox and edge");
